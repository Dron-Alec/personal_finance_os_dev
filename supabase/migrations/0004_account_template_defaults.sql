-- Update the default account_templates seeded on signup to match the
-- user's preferred starter list (name, type):
-- Checking, Savings, Coinbase/Crypto, 401k, Roth IRA, Taxable Brokerage,
-- Other Investments. Only the account_templates insert values change from
-- 0003 — category_rules/nw_targets seeding is untouched.
